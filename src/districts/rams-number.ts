...
import lettering from './rams-number.json';
/** Original displayed-word outlines. Typeface, size and relief are inferred. */
export function buildRamsNumber(width:number,height:number,depth=.003){
