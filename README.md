...
[118-second demo](artifacts/fork/media/STREETWISE-demo.mp4) · [Pitch PDF](artifacts/fork/media/STREETWISE-pitch.pdf) · [Editable slides](artifacts/fork/media/pitch.html) · [Submission copy](docs/fork/submission.md)
