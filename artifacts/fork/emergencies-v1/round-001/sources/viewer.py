...
def main():
    ...
    p.add_argument('--environment',choices=['crossing','hazards','weather','streetlife','emergencies'],default='crossing')
    ...
    args=p.parse_args()
    cls=CentralAvenueG1
    if args.environment=='emergencies':
        from emergencies import CentralAvenueEmergencies
        cls=CentralAvenueEmergencies;cls.difficulty=args.difficulty
    elif args.environment=='streetlife':
    ...
    if args.chennai:
        ...
        instances=3 if args.environment in ('streetlife','emergencies') else 1
    ...
    default={'crossing':'rl-corridor-v2','hazards':'rl-hazards-v2','weather':'rl-weather','streetlife':'streetlife-multiple-shelters/round-001','emergencies':'emergencies-v1/round-001'}[args.environment]
